...
for grains in range(1, 21):
  ...
  g1_embeds_numpy.to_csv("s1"+"_g"+str(grains)+"_embeds_raw.csv", index = False)

  g2_embeds_numpy = pd.DataFrame(g2_embeds.numpy())
  g2_embeds_numpy.to_csv("s2"+"_g"+str(grains)+"_embeds_raw.csv", index = False)

  g3_embeds_numpy = pd.DataFrame(g3_embeds.numpy())
  g3_embeds_numpy.to_csv("s3"+"_g"+str(grains)+"_embeds_raw.csv", index = False)

  g4_embeds_numpy = pd.DataFrame(g4_embeds.numpy())
  g4_embeds_numpy.to_csv("s4"+"_g"+str(grains)+"_embeds_raw.csv", index = False)
  ...
  # Download the grain files:

  # files.download("s1"+"_g"+str(grains)+"_embeds_raw.csv")
  # files.download("s2"+"_g"+str(grains)+"_embeds_raw.csv")
  # files.download("s3"+"_g"+str(grains)+"_embeds_raw.csv")
  # files.download("s4"+"_g"+str(grains)+"_embeds_raw.csv")
...
# files.download("karma.grained_similarity.csv")
# umap_df.to_csv("karma.grained_umap_embeds.csv", index = False)
# files.download("karma.grained_umap_embeds.csv")
