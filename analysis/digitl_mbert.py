...
clean_split = pd.read_csv("../data/text_split/all.clean.split_V2.csv")
...
s1_embeds_numpy.to_csv("../data/embeddings/mbert/s1_embeds_raw.csv", index = False)

s2_embeds_numpy = pd.DataFrame(s2_embeds.numpy())

s2_embeds_numpy.to_csv("../data/embeddings/mbert/s2_embeds_raw.csv", index = False)

s3_embeds_numpy = pd.DataFrame(s3_embeds.numpy())

s3_embeds_numpy.to_csv("../data/embeddings/mbert/s3_embeds_raw.csv", index = False)

s4_embeds_numpy = pd.DataFrame(s4_embeds.numpy())

s4_embeds_numpy.to_csv("../data/embeddings/mbert/s4_embeds_raw.csv", index = False)
...
full_similarity.to_csv("../data/embeddings/similarity_matrices/karma.combined_similarity.csv", index = False)
...
umap_embeds.to_csv("../data/embeddings/karma.umap_embeds.csv", index = False)
