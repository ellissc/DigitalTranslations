...
text1.embeds <- read_csv("../data/embeddings/mbert/s1_embeds_raw.csv", show_col_type = F) |> 
  clean_names() |> 
  mutate(sent_num = 1:n()) 
text2.embeds <- read_csv("../data/embeddings/mbert/s2_embeds_raw.csv", show_col_type = F)|> 
  clean_names() |> 
  mutate(sent_num = 1:n()) 
text3.embeds <- read_csv("../data/embeddings/mbert/s3_embeds_raw.csv", show_col_type = F)|> 
  clean_names() |> 
  mutate(sent_num = 1:n()) 
text4.embeds <- read_csv("../data/embeddings/mbert/s4_embeds_raw.csv", show_col_type = F)|> 
  clean_names() |> 
  mutate(sent_num = 1:n()) 
...
dtw.df <- data.frame(story = c("text1", "text2","text3", "text4"),
                     text1 = c(text1.text1.distance, text2.text1.distance, text3.text1.distance, text4.text1.distance),
                     text2 = c(text1.text2.distance, text2.text2.distance, text3.text2.distance, text4.text2.distance),
                     text3 = c(text1.text3.distance, text2.text3.distance, text3.text3.distance, text4.text3.distance),
                     text4 = c(text1.text4.distance, text2.text4.distance, text3.text4.distance, text4.text4.distance)) |> 
  melt() |> 
