...
text1.clean.split <- text1.clean |> 
  tokenize_sentences() |> 
  unlist() 
text1.clean.split <- tibble(story = 1, lang = "eng", sentences = text1.clean.split) 

text2.clean.split <- text2.clean |> 
  tokenize_sentences() |> 
  unlist() 
text2.clean.split <- tibble(story = 2, lang = "rus", sentences = text2.clean.split)

text3.clean.split <- text3.clean |> 
  tokenize_sentences() |> 
  unlist() 
text3.clean.split <- tibble(story = 3, lang = "fre", sentences = text3.clean.split)

text4.clean.split <- text4.clean |> 
  tokenize_sentences() |> 
  unlist()
text4.clean.split <- tibble(story = 4, lang = "eng", sentences = text4.clean.split)
...
for (grains in 1:20){
  ...
  text1.grained <- data.frame(story = 1, lang = "eng",
  ...
  text3.grained <- data.frame(story = 3, lang = "fre",
...
for (window in 1:20){
  ...
  text1.window <- data.frame(story = 1, lang = "eng",
  ...
  text2.window <- data.frame(story = 2, lang = "rus",
  ...
  text3.window <- data.frame(story = 3, lang = "fre",
...
## Load in the files ----
text1 <- read_file("../data/Karma texts/final/English_1_1894.final.txt")
text2 <- read_file("../data/Karma texts/final/Russian_2_1894.final.txt")
text3 <- read_file("../data/Karma texts/final/French_3_1895.final.txt")
text4 <- read_file("../data/Karma texts/final/English_4_1896.final.txt")
...
for (grains in 1:20){
  ...
  text4.grained <- data.frame(story = 4, lang = "eng",
...
for (window in 1:20){
  ...
  text4.window <- data.frame(story = 4, lang = "eng",
